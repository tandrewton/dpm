...
for att in ${att_arr[@]}; do 
  for v0 in ${v0_arr[@]}; do
    for koff in ${koff_arr[@]}; do
        echo bash bash/cells/submit_psm.sh 40 20 $calA0 0.9 $att 0.0 $v0 50.0 $koff 1000 pi_ohern,day 0-12:00:00 $numSeeds 1 >> joblist_psm_att_v0_koff.txt
    done
  done
done
...
bash bash/cells/submit_psm.sh 40 20 1.05 0.9 0 0.0 0.05 50.0 10.0 1000 pi_ohern,day 0-12:00:00 1 1
